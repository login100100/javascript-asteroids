...
var graphicAssets = {
    ship:{URL:'assets/shipperino1.png', name:'ship'},
    bullet:{URL:'assets/bullet.png', name:'bullet'},    
    
    asteroidLarge:{URL:'assets/asteroid-big.png', name:'asteroidLarge'},
    asteroidMedium:{URL:'assets/asteroid-mid.png', name:'asteroidMedium'},
    asteroidSmall:{URL:'assets/asteroid-small.png', name:'asteroidSmall'},
